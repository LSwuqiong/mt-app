...
<div class="page-register">
    ...
    <div class="content">
        <el-form :model="registerForm" status-icon :rules="registerForm" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="密码" prop="password">
                ...
                <el-form-item label="确认密码" prop="repassward">
                    <el-input type="repassward" v-model="registerForm.repassward" autocomplete="off"></el-input>
                </el-form-item>
